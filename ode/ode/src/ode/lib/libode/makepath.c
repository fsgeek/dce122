 ...
 * HISTORY
 * $Log: makepath.c,v $
 * Revision 1.9.7.1  1994/01/21  20:29:06  marty
 * 	CR # 865 - Can only have one COPY RIGHT NOTICE marker in file
 * 	[1994/01/21  20:27:25  marty]
 *
...
static char *fixpath(register char *fpath, char *buf)
{
...
int makepath(char *mpath, char *refpath, int trace, int showerrs)
{
