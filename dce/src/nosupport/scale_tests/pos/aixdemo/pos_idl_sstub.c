...
static Howdy_v0_0_epv_t IDL_manager_epv = {
rpc_QUERY_MSG
,rpc_MESSAGE
,rpc_KILL
};
...
(*((Howdy_v0_0_epv_t *)IDL_mgr_epv)->rpc_QUERY_MSG)(hBinding,
    &qmsg_buf_len,
    &qmsg_buf);
...
IDL_manager_entered = ndr_true;
RPC_SS_THREADS_ENABLE_GENERAL(IDL_general_cancel_state);
(*((Howdy_v0_0_epv_t *)IDL_mgr_epv)->rpc_MESSAGE)(hBinding,
    &msg_buf_len,
    &msg_buf);
RPC_SS_THREADS_RESTORE_GENERAL(IDL_general_cancel_state);
{
...
IDL_manager_entered = ndr_true;
RPC_SS_THREADS_ENABLE_GENERAL(IDL_general_cancel_state);
(*((Howdy_v0_0_epv_t *)IDL_mgr_epv)->rpc_KILL)(hBinding);
RPC_SS_THREADS_RESTORE_GENERAL(IDL_general_cancel_state);
{
rpc_ss_ndr_marsh_interp(
    0,
...
/* global */ rpc_if_handle_t Howdy_v0_0_s_ifspec = (rpc_if_handle_t)&IDL_ifspec;
#ifdef VMS
#pragma standard
#endif
